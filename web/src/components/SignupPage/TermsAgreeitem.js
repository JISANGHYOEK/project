...
function TermsAgreeitem() {
  ...
  return (
    <div className="signup-page">
      <div>
        <label className="signup-label1">케이투자 회원가입</label>
        <br />
        <br />
        <br />
...
제 1 조 (목적)
본 약관은 미래투자와 케이투자가 운영하는 웹 사이트 (http://xxx.xxx.xxx)의 제반 서비스의 이용조건 및 절차에 관한 사항 및 기타 필요한 사항을 규정함을 목적으로 한다.
...
본 약관은 2023년 11월 23일부터 적용한다.`}</textarea>
        ...
        <br />
        <br />
        <Checkbox checked={personal} onChange={setPersonal}>
          <label htmlFor="agree_check_info">[필수] 개인정보 처리 방침</label>
          <br />
          <textarea
            className="textarea-style"
            readOnly
          >{`< 미래투자 >와< 케이투자 >은(는) 「개인정보 보호법」 제30조에 따라 정보주체의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보 처리방침을 수립·공개합니다.
...
< 미래투자 >와 < 케이투자 >은(는) 다음의 목적을 위하여 개인정보를 처리합니다. 처리하고 있는 개인정보는 다음의 목적 이외의 용도로는 이용되지 않으며 이용 목적이 변경되는 경우에는 「개인정보 보호법」 제18조에 따라 별도의 동의를 받는 등 필요한 조치를 이행할 예정입니다.
...
① < 케이투자 >은(는) 법령에 따른 개인정보 보유·이용기간 또는 정보주체로부터 개인정보를 수집 시에 동의받은 개인정보 보유·이용기간 내에서 개인정보를 처리·보유합니다.
...
① < 케이투자 >은(는) 원활한 개인정보 업무처리를 위하여 다음과 같이 개인정보 처리업무를 위탁하고 있습니다.

1.
위탁받는 자 (수탁자) : 로그인ID
위탁하는 업무의 내용 : 회원제 서비스 이용에 따른 본인확인
위탁기간 : 회원탈퇴시
② < 케이투자 >은(는) 위탁계약 체결시 「개인정보 보호법」 제26조에 따라 위탁업무 수행목적 외 개인정보 처리금지, 기술적․관리적 보호조치, 재위탁 제한, 수탁자에 대한 관리․감독, 손해배상 등 책임에 관한 사항을 계약서 등 문서에 명시하고, 수탁자가 개인정보를 안전하게 처리하는지를 감독하고 있습니다.
...
① 정보주체는 케이투자에 대해 언제든지 개인정보 열람·정정·삭제·처리정지 요구 등의 권리를 행사할 수 있습니다.

② 제1항에 따른 권리 행사는케이투자에 대해 「개인정보 보호법」 시행령 제41조제1항에 따라 서면, 전자우편, 모사전송(FAX) 등을 통하여 하실 수 있으며 케이투자은(는) 이에 대해 지체 없이 조치하겠습니다.
...
⑥ 케이투자은(는) 정보주체 권리에 따른 열람의 요구, 정정·삭제의 요구, 처리정지의 요구 시 열람 등 요구를 한 자가 본인이거나 정당한 대리인인지를 확인합니다.



제5조(처리하는 개인정보의 항목 작성)

① < 케이투자 >은(는) 다음의 개인정보 항목을 처리하고 있습니다.
...
① < 케이투자 > 은(는) 개인정보 보유기간의 경과, 처리목적 달성 등 개인정보가 불필요하게 되었을 때에는 지체없이 해당 개인정보를 파기합니다.
...
1. 파기절차
< 케이투자 > 은(는) 파기 사유가 발생한 개인정보를 선정하고, < 케이투자 > 의 개인정보 보호책임자의 승인을 받아 개인정보를 파기합니다.
...
< 케이투자 >은(는) 개인정보의 안전성 확보를 위해 다음과 같은 조치를 취하고 있습니다.
...
케이투자 은(는) 정보주체의 이용정보를 저장하고 수시로 불러오는 ‘쿠키(cookie)’를 사용하지 않습니다.

제9조 (개인정보 보호책임자)

① 케이투자 은(는) 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보 처리와 관련한 정보주체의 불만처리 및 피해구제 등을 위하여 아래와 같이 개인정보 보호책임자를 지정하고 있습니다.
...
담당자 :
연락처 :, ,
② 정보주체께서는 케이투자 의 서비스(또는 사업)을 이용하시면서 발생한 모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을 개인정보 보호책임자 및 담당부서로 문의하실 수 있습니다. 케이투자 은(는) 정보주체의 문의에 대해 지체 없이 답변 및 처리해드릴 것입니다.

제10조(개인정보 열람청구)
정보주체는 ｢개인정보 보호법｣ 제35조에 따른 개인정보의 열람 청구를 아래의 부서에 할 수 있습니다.
< 케이투자 >은(는) 정보주체의 개인정보 열람청구가 신속하게 처리되도록 노력하겠습니다.
...
① 이 개인정보처리방침은 2021년 1월 1부터 적용됩니다.`}</textarea>
      ...
      <Checkbox checked={terms && personal} onChange={handleAllAgreementChange}>
        <label className="signup-label3" htmlFor="agree_check_all">
          전체 동의하기
        </label>
        <br />
        <br />
