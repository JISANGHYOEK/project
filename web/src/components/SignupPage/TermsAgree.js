            ...
            <div>
                ...
                <ul>
                    <li>
                        ...
                        <label htmlFor="agree_check_all">전체 동의하기</label><br/>
                    </li>
                    <li>
                        <input
                            type="checkbox"
                        ...
                        <textarea class="left-aligned-text" readOnly rows={10} cols={48}>{`제 1 장 총칙
...
본 약관은 2023년 11월 23일부터 적용한다.`}</textarea>
                    ...
                    <li>
                        ...
                        <textarea class="left-aligned-text" readOnly rows={10} cols={48}></textarea>
                    </li>
                </ul>
            </div>
        </div>
